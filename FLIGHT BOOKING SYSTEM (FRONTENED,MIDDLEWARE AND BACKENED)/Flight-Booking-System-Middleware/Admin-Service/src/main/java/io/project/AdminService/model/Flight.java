package io.project.AdminService.model;
...
public class Flight {
	...
	public Flight(String id, String flight_number, String flight_name, String traveling_from, String traveling_to,
			int distance_in_km, int flight_fare_in_rupees, String date_of_travel, String departure_time,
			String arrival_time, int number_of_available_seats) {
		super();
		this.id = id;
	...
	public Flight(String flight_number, String flight_name, String traveling_from, String traveling_to,
			int distance_in_km, int flight_fare_in_rupees, String date_of_travel, String departure_time,
			String arrival_time, int number_of_available_seats) {
		super();
